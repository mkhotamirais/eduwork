...
export const H1 = ({ children, id, className }) => (
  <h1 id={id} className={`${className} font-semibold capitalize text-xl md:text-2xl leading-loose py-2`}>
    {children}
  </h1>
);
H1.propTypes;
...
export const H2 = ({ children }) => (
  <h2 className={`font-medium capitalize text-lg md:text-xl leading-relaxed py-2`}>{children}</h2>
);
H2.propTypes;
