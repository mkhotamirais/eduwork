...
import { fetchCity, fetchDistrict, fetchProvince, getCity, getDistrict, getProvince } from "../../features/cartsSlice";
...
const CartFrom = ({ setId }) => {
  ...
  useEffect(() => {
    ...
    if (provId) {
      ...
      if (cityId) {
        dispatch(fetchDistrict(cityId));
      }
    }
    if (districtId) {
      setId(districtId);
    }
  }, [provId, cityId, dispatch, districtId, setId]);
